...
public class AppsGames extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedIntanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent vaiProDetalhes = new Intent(AppsGames.this, DetalhesApps.class);
    ...
    public void RetrofitGames() {
        Call<PacoteSync> call = new RetrofitInicializador().getPacoteService().buscarGames();
        ...
        call.enqueue(new Callback<PacoteSync>() {
            ...
            public void onResponse(@NonNull Call<PacoteSync>  call, @NonNull Response<PacoteSync> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (mPacoteSync != null) {
                        mAdapter = new PacoteAppsAdapter(mPacoteSync.getAplicativos(), AppsGames.this);
                    }
